...
# | パラメータ | 物理量 | 使う章 |
# |---|---|---|
# | 面積 $A\sigma\sqrt{2\pi}$ | **輻射強度** [erg cm⁻² s⁻¹ sr⁻¹] | 第 2・5 章 |
# | 中心 $\lambda_0$ | **ドップラー速度** | 第 3 章 |
# | 幅 $\sigma$ | **装置の波長分解能 + 熱運動 + 非熱的速度** | 第 4 章 |
#
# **輻射強度は測定値ではなく、フィットの産物**です。背景をどこに引くか、
...
# （eispac の関数の使い方は [付録 K](#eispac) にまとめてあります）
...
# ## まとめ
#
# - 輻射強度は**ガウシアンの面積** $A\sigma\sqrt{2\pi}$。**フィットの産物**
