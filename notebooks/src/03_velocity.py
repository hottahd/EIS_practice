...
# 記録の刻み 0.0223 Å は 195 Å では **34 km/s** に相当する。
# つまり**刻みの 1/10 以下のずれ**を測ることになる。
...
print(f"記録の刻み 0.0223 Å = {C_KMS*0.0223/LAM0:.0f} km/s")
...
# ## まとめ
#
# - ドップラー速度は**中心波長のずれ**。記録の刻みが 34 km/s なので、その 1/10 以下を測る
